...
import SearchableDropdown from "../../AdminComponent/Communication/Messages/SearchableDropdown";
...
const StartLiveNext: React.FC<ReciptSettingPopUpProps> = ({ }) => {
  ...
  return (
    <>
      <form className="space-y-4">
        {/* Gender Selection */}
        <h1 className="text-2xl font-semibold">Set Visibility Settings</h1>
