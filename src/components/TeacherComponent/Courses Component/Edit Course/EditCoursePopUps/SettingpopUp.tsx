...
<div className='flex items-center gap-4 px-5'>
      ...
      <p className='text-[#555] lg:text-[.8vw] text-[3.3vw]'>Bought From Another teacher</p>
      </div> 
      <select className='py-1 lg:mx-16 rounded-xl bg-cardBg lg:w-80 w-72 lg:text-[.8vw] text-[3.3vw]' name="" id="">
            <option className='py-1 lg:text-[.8vw] text-[3.3vw]bg-cardBg' value="">Select Teacher</option>
      ...
      <div className='flex items-center gap-4 px-5 lg:text-[.8vw] text-[3.3vw]'>
      <input className='w-2 h-2 text-primary' type="checkBox" />
...
<h5 className='font-semibold'>Groups</h5> 
      <select className='py-2 rounded-md w-72 bg-cardBg lg:text-[.8vw] text-[3.3vw]' name="" id="">
