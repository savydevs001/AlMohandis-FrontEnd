...
import EditCourseDescription from "./EditCourseDesc";
import SeasonPopUp from "../CreateCourseComp/SeasonPopUp";
// import { useState } from "react";
...
function EditCourseForm() {
  ...
  return (
    <div className="w-full mt-8 space-y-5">
      ...
      {isSeasonPopUpOpen && (
        <SeasonPopUp  partNumber={0} setPartContainer={() => {}} setPartNumber={() => {}}onClose={handleCloseSeasonPopUp} 
        />
      )}
    </div>
  );
