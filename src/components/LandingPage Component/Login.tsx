                        ...
                        <div className='form-data w-full lg:w-[45%] h-fit py-16 px-6 bg-[#F7EFE2] rounded-lg '>
                              <form className='flex flex-col space-y-4' onSubmit={handleSubmit}>
                                    ...
                                    <div className='flex flex-col gap-2'>
                                          ...
                                          <input className='w-full py-2 rounded-md' type="text" placeholder='Enter your Mobile Number' value={phone} onChange={(e) => setPhone(e.target.value)} />
                                    </div>
                                    ...
                                    <div className='flex flex-col gap-1'>
                                          ...
                                          <input className='w-full rounded-md ' type="password" placeholder='Enter Your Password' value={password} onChange={(e) => setPassword(e.target.value)} />

                                    </div>
                                    <button className='w-full px-4 py-3 text-lg font-semibold rounded-lg bg-primary text-txtColor' disabled={loading}>Login</button>
