...
import ShowAssignments from './ShowContent/ShowAssignment/ShowAssignment';
import SingleAssignment from './ShowContent/ShowAssignment/SingleAssignment';
import SingleExam from './ShowContent/ShowExam/SingleExam';
