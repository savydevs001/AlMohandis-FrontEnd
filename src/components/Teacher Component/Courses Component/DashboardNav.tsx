...
<li>
<NavLink to={'/courses'} end className={({ isActive }) => isActive ? 'text-tertiary border-b border-primary font-semibold flex items-center gap-4' : 'text-tertiary flex items-center gap-4'}>Published</NavLink>
</li>
<li>
