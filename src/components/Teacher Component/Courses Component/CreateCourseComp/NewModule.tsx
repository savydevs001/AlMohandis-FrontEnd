...
const NewModule: React.FC<Step7RigthModuleProps> = ({ title }) => { // Receive title as a prop
    ...
    <div>
      <div className='flex flex-col justify-between w-full gap-4'>
        <div className='space-y-4 w-[90%]'>
          <div>
            <label className="font-semibold" htmlFor="title">{title}</label> {/* Display title prop */}
          ...
          <div className='space-y-4'>
            ...
            <div className='flex flex-col gap-1'>
              ...
              <textarea className='w-full border rounded-md' name="description" id="description"></textarea>
            </div>
          </div>
        </div>
        ...
        <div className='space-y-4'>
          <div className='w-[100%]'>
            <label className='font-semibold' htmlFor="lessonFile">Lesson File</label>
            <div className='w-[100%] border border-dashed border-primary p-2 text-center text-primary space-y-4'>
              ...
              // onClick={handleOpenLessonFilePopUp}
              
              className='px-2 py-0 text-xl font-semibold text-white border rounded-md bg-primary'>+</button>
            </div>
          </div>
          <div className='w-[100%]'>
            <label className='font-semibold' htmlFor="attachment">Attachment</label>
            <div className='w-[100%] border border-dashed border-primary p-2 text-center text-primary space-y-4'>
              <p>Browse and choose the files you want to upload from your computer</p>
              <button className='px-2 py-0 text-xl font-semibold text-white border rounded-md bg-primary'
              
              // onClick={handleOpenAttachmentPopUp}
