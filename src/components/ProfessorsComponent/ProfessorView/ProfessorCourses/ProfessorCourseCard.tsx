...
function ProfessorCourseCard() {
  return (
      ...
      <div className="w-full p-2 text-black rounded-lg shadow-xl max-h-fit card">
  ...
  <div className="items-center text-center card-body">
    ...
    <h3 className='text-xl font-bold text-primary' >Field</h3>
    </div>
    <div className="w-[90%] m-auto mt-3 p-2 border-2 card-actions bg-primary rounded-lg mb-3 text-white">
      <button className="flex items-center gap-2 font-medium btn btn-primary">Go to Courses
