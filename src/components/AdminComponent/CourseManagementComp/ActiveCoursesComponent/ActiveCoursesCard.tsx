...
import DeleteConfirmationPopup from '../../../TeacherComponent/Courses Component/DeletePopUp'; // Import the new popup component
...
const ActiveCoursesCard: React.FC<CoursesByMeCardProps> = ({ name, published, students, button, showButton }) => {
