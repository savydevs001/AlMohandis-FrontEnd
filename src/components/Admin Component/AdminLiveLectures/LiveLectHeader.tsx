...
import AdminLiveLectureTable from './LiveLecture/LiveLectureTable';
import AdminPendingApprobal from './Approval/PendingApprobal';
import LiveLectureRejected from './LivePermission/LiveLectureRejected';
