...
import AdminLiveLectureTable from './AdLiveLecTableComp/AdminLiveLectureTable';
import AdminPendingApprobal from './AdPenApprovlComp/AdminPendingApprobal';
import LiveLectureRejected from './AdminLiveRejectComp/LiveLectureRejected';
