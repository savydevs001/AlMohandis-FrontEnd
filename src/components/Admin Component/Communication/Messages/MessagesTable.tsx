...
import ViewMessagesPopup from "./ViewMessagePopup";
...
const MessagesTable: React.FC = () => {
  ...
  const [data, setData] = useState<RowData[]>([
    { id: "Student", name: '"Exam Reminder"', assistant: "2023-09-10", startDate: "500", status: "2500" },
    { id: "Student", name: '"Exam Reminder"', assistant: "2023-09-10", startDate: "500", status: "2500" },
        ...
        <table className="w-full text-center border-collapse">
          <thead>
            <tr className="text-white bg-primary">
              ...
              <th className="px-4 py-2 border border-black">Reads</th>
              <th className="px-4 py-2 border border-black">Unread</th>
