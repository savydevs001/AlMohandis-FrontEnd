...
import GeneralInformation from "./StudentGeneralInformation/GeneralInformation";
import AdminStudentCourse from './StudentCourses/AdminStudentCourse';
import AdminLiveLecture from './LiveLecturesComponent/AdminLiveLecture';
import AdminRegisteredStudent from '../RegisteredStudentComponent/AdminRegisteredStudent';
