...
const AddStudentPopUp: React.FC<AddTeacherPopupProps> = ({ onClose }) => {
  return (
...
<p className='px-3 py-1 text-white rounded-full bg-pTag'>Male</p>
         ...
         <div className='flex items-center'>
            <label className='w-[25%] font-semibold' htmlFor="">Enrollment</label>
         ...
         <div className='flex items-center'>
            <label className='w-[25%] font-semibold' htmlFor="">Program</label>
            <input className='w-[70%] rounded-md py-1 border-slate-300' type="text" placeholder='BS Information Technology' />
         </div>
         <div className='flex items-center'>
            <label className='w-[25%] font-semibold' htmlFor="">Class</label>
            <input className='w-[70%] rounded-md py-1 border-slate-300' type="text" placeholder='22-CS' />
         </div>
