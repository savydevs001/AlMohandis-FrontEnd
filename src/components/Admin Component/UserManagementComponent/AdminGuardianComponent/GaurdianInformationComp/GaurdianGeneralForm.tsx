...
import ChangePassword from '../../StudentComponents/AdminStudentInformation/StudentGeneralInformation/ChangePassword';

function GaurdianGeneralInfoForm() {
      ...
      <div className="space-y-2">
        ...
        <form className="flex flex-col space-y-3">
          {[
            ...
            { label: 'Relation', placeholder: 'Father', type: 'text' },
            ...
            <div className="flex flex-col items-center gap-2 lg:flex-row lg:gap-8" key={index}>
              <label className="font-semibold text-[#333] lg:w-[17%] w-full" htmlFor={field.label}>{field.label}</label>
              <input
...
export default GaurdianGeneralInfoForm;
