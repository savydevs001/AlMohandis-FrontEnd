...
import UserGrowthGraph from "../../AdminDashBoardContent/USerGrowthGraph";

function LoginFrequencyGraph() {
  ...
  return (
    <div className="lg:w-[50%] w-full p-3 bg-white rounded-md shadow-sm space-y-3">
      <div className="flex items-center justify-between">
            <h1 className="text-xl font-semibold">Login Frequency Over Time</h1>
            <button
